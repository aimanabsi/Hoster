...
namespace ZServer
{
    public class RocheCobas411ASTMContext : ISerialContext
    {
        /// <summary>
        ...
        bool gotSTX = false;
        bool gotETX = false;
        public RocheCobas411ASTMContext(SerialPortInput stream, int responseDelay)
        {
                        ...
                        if (resultsRows.Count() > 1)
                        {
                            ...
                            foreach (string row in resultsRows)
                            {
                                ...
                                if (row.Trim() != "")
                                {
                                    ...
                                    tempMessage.TESTREFERENCE = reference.Replace('^','-');
