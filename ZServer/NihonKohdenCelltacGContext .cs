...
namespace ZServer
{
    public class NihonKohdenCelltacGContext : IZClientContext, IDisposable
    {
        ...
        public NihonKohdenCelltacGContext(EndPoint remoteEndPoint, Stream stream, Socket socket, int bufferSize, bool autoResond, int responseDelay)
        {
            _wait = responseDelay;
