...
namespace ZServer.Parser.astm
{
    public class Component : MessageElement
    {
        ...
        public Component(ASTMEncoding encoding, bool isDelimiter = false)
        {
            this.isDelimiter = isDelimiter;
            this.SubComponentList = new List<SubComponent>();
            this.Encoding = encoding;
        }
        public Component(string pValue, ASTMEncoding encoding)
        {
            this.SubComponentList = new List<SubComponent>();
            this.Encoding = encoding;
            this.Value = pValue;
        ...
        public SubComponent SubComponents(int position)
        {
            ...
            {
                throw new ASTMException("SubComponent not availalbe Error-" + ex.Message);
            }
