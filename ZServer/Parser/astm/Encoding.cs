...
namespace ZServer.Parser.astm
{
    public class ASTMEncoding
    {
        ...
        public void EvaluateSegmentDelimiter(string message)
        {
            ...
            throw new ASTMException("Segment delimiter not found in message", ASTMException.BAD_MESSAGE);
        }
        ...
        public string Decode(string encodedValue)
        {
            ...
            for (int i = 0; i < encodedValue.Length; i++)
            {
                ...
                //if (li == -1)
                //    throw new ASTMException("Invalid escape sequence in ASTM string");
