...
namespace ZServer.Parser.astm
{
    public class Field : MessageElement
    {
        ...
        public Field(ASTMEncoding encoding)
        {
            this.ComponentList = new ComponentCollection();
            this.Encoding = encoding;
        }

        public Field(string value, ASTMEncoding encoding)
        {
            this.ComponentList = new ComponentCollection();
            this.Encoding = encoding;
            this.Value = value;
        ...
        public bool AddNewComponent(Component com)
        {
            ...
            {
                throw new ASTMException("Unable to add new component Error - " + ex.Message);
            }
        }
        ...
        public Component Components(int position)
        {
            ...
            {
                throw new ASTMException("Component not available Error - " + ex.Message);
            }
