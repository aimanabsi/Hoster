...
namespace ZServer.Parser.astm
{
    public class Segment : MessageElement
    {
        ...
        public Segment(ASTMEncoding encoding)
        {
            this.FieldList = new FieldCollection();
            this.Encoding = encoding;
        }

        public Segment(string name, ASTMEncoding encoding)
        {
            this.FieldList = new FieldCollection();
            this.Name = name;
            this.Encoding = encoding;
        ...
        public bool AddNewField(Field field, int position = -1)
        {
            ...
            {
                throw new ASTMException("Unable to add new field in segment " + this.Name + " Error - " + ex.Message);
            }
        }
        ...
        public Field Fields(int position)
        {
            ...
            {
                throw new ASTMException("Field not available Error - " + ex.Message);
            }
